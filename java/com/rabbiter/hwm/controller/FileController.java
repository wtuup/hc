...
import com.rabbiter.hwm.entity.Files;
import com.rabbiter.hwm.mapper.FileMapper;
...
public class FileController {
    ...
    /**
     * 文件上传接口
     * @param file 前端传递过来的文件 以及表单写的内容（名字）
     * @return
     * @throws IOException
     */
    ...
    /**
     * 文件下载接口   http://localhost:port/file/{fileUUID}
     * @param fileUUID
     * @param response
     * @throws IOException
     */
    ...
    public void downloadFile(@PathVariable String fileUUID, HttpServletResponse response) throws IOException {
        ...
        String fileName = URLEncoder.encode(fileUUID, "UTF-8");
